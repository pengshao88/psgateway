...
public class GatewayHandler {
    ...
    // curl -H "Content-Type: application/json" -X POST -d '{"service":"cn.pengshao.rpc.demo.api.UserService", "methodSign":"findById_Integer", "args":[100]}' http://localhost:8888/gw/cn.pengshao.rpc.demo.api.UserService
